...
const IndexScreen = ({ navigation }) => {
  ...
  const [idioma, setIdioma] = useState('es'); // idioma actual
  ...
  const categories = [
    // Puedes mapear tus categorías aquí con traducciones:
    // { id: 1, name: t('senderismo'), icon: 'pine-tree', screen: 'Senderismo' },
    // { id: 2, name: t('playas'), icon: 'beach', screen: 'Playas' },
  ];
          ...
          <View style={tw`flex-row justify-between items-center`}>
            <View style={tw`flex-1`}>
              <Text style={tw`text-2xl font-bold text-[#101C5D] mb-1`}>
                {t('hello', { name: Nom_Cli ? Nom_Cli : 'Turista' })}
              </Text>
              <Text style={tw`text-base text-[#333333]`}>
                {t('what_adventure_today')}
              </Text>
            </View>
        ...
        <View style={tw`px-6`}>
          ...
          <View style={tw`mb-4`}>
            <View style={tw`flex-row justify-between items-center mb-6`}>
              ...
              >
                <Text style={tw`text-sm text-[#569298] font-medium mr-1`}>
                  {t('see_all')}
                </Text>
            ...
            <List navigation={navigation} idioma={idioma} />
          </View>
        </View>
      </ScrollView>
